...
class ventanaLogin(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("Login Grupo 10")
    ...
    def initUI(self):
      ...
      # ==================== FRAME ENCABEZADO ====================
        ...
        labelTitulo = QLabel("<font color='white'>Luis Guachilema, Juan Yasig </font>", frame)
        labelTitulo.setFont(fuenteTitulo)
        labelTitulo.move(60, 20)

        fuenteSubtitulo = QFont()
        fuenteSubtitulo.setPointSize(9)

        labelSubtitulo = QLabel("<font color='white'>Avance de interfaz, usando PyQt5"
                                "(Python).</font>", frame)
        labelSubtitulo.setFont(fuenteSubtitulo)
        labelSubtitulo.move(96, 46)
